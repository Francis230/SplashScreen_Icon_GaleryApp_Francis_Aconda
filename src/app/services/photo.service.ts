...
// Importacion sobre desplegar en una app
...
// Método para guardar la foto en el sistema de archivos local
...
public async addNewToGallery(quality: number = 100) {
  ...
  if (!hasPermission) {
    alert('Permiso de cámara denegado. Por favor otórgalo en los ajustes del sistema.');
    return;
  }
...
// Interfaz para el tipo de datos de la foto
